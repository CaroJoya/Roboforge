    ...
    <div id="editPhotoModal" class="modal">
        <div class="modal-content">
            ...
            <form id="editPhotoForm" method="POST" action="update_profile_photo.php" enctype="multipart/form-data">
                ...
                <input type="file" name="profile_photo" accept="image/jpeg,image/png" required id="photoFileInput">
                <div id="photoPreview" style="display: none; margin: 1rem 0; text-align: center;">
                    <img id="photoPreviewImg" src="" alt="Preview" style="max-width: 100%; max-height: 300px; border-radius: 10px;">
                </div>
                <div class="modal-buttons">
                    <button type="button" class="cancel-btn" onclick="closeEditPhotoModal()">Cancel</button>
                    <button type="submit" class="save-btn" id="uploadPhotoBtn">
